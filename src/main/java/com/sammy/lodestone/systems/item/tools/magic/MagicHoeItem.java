...
import com.sammy.lodestone.systems.item.tools.LodestoneHoeItem;
...
public class MagicHoeItem extends LodestoneHoeItem {
	...
	public MagicHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, float magicDamage, Item.Settings settings) {
