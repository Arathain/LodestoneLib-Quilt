...
import com.sammy.lodestone.systems.item.tools.LodestoneAxeItem;
...
public class MagicAxeItem extends LodestoneAxeItem {
	...
	public MagicAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, float magicDamage, Item.Settings settings) {
