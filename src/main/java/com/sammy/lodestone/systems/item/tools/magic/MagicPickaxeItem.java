...
import com.sammy.lodestone.systems.item.tools.LodestonePickaxeItem;
...
public class MagicPickaxeItem extends LodestonePickaxeItem {
	...
	public MagicPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, float magicDamage, Item.Settings settings) {
